                    ...
                    @if($upcoming)
                        ...
                        <div class="md:w-2/3 space-y-6">
                            ...
                            <div class="flex gap-4">
                                <a href="{{ url('/Pasien/Dashboard') }}" class="flex-1 bg-primary text-white py-3 rounded-lg font-label-md text-label-md hover:bg-opacity-90 active:scale-95 transition-all text-center block">Refresh</a>
                                <a href="{{ url('/#booking-section') }}" class="flex-1 border border-primary text-primary py-3 rounded-lg font-label-md text-label-md hover:bg-primary/5 active:scale-95 transition-all text-center block">Ambil Tiket Baru</a>
                            </div>
                        </div>
                    @else
